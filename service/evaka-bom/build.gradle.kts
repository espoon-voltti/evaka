...
dependencies {
    constraints {
        ...
        api("com.github.kagkarlsson:db-scheduler:16.9.0")
        api("com.github.mwiede:jsch:2.28.2")
        ...
        api("nz.net.ultraq.thymeleaf:thymeleaf-layout-dialect:4.0.1")
        ...
        api("org.apache.tika:tika-core:3.3.0")
    ...
    api(platform("software.amazon.awssdk:bom:2.44.8"))
}
