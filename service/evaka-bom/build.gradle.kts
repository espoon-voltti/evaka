...
dependencies {
    constraints {
        api("ch.qos.logback.access:logback-access-tomcat:2.0.7")
        api("com.auth0:java-jwt:4.5.0")
        api("com.github.kagkarlsson:db-scheduler:16.6.0")
        api(libs.fuel)
        ...
        api("io.kotest:kotest-property:6.0.5")
    ...
    api(platform("io.opentelemetry:opentelemetry-bom:1.56.0"))
    ...
    api(platform("software.amazon.awssdk:bom:2.39.5"))
}
