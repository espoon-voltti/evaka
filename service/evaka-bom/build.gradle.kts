...
dependencies {
    constraints {
        ...
        api("nz.net.ultraq.thymeleaf:thymeleaf-layout-dialect:4.0.0")
    ...
    api(platform("software.amazon.awssdk:bom:2.42.18"))
}
