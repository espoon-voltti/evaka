...
class PlacementQueriesIntegrationTest : PureJdbiTest(resetDbBeforeEach = true) {
    ...
    @Test
    fun `clearFutureReservationsAndAbsencesOutsideValidPlacements for club placement`() {
        `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
    ...
    @Test
    fun `clearFutureReservationsAndAbsencesOutsideValidPlacements for daycare placement`() {
        `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
    ...
    @Test
    fun `clearFutureReservationsAndAbsencesOutsideValidPlacements for preschool placement`() {
        `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
    ...
    @Test
    fun `clearFutureReservationsAndAbsencesOutsideValidPlacements for preschool_daycare placement`() {
        `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
    ...
    @Test
    fun `clearFutureReservationsAndAbsencesOutsideValidPlacements for preparatory placement`() {
        `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
    ...
    @Test
    fun `clearFutureReservationsAndAbsencesOutsideValidPlacements for preparatory_daycare placement`() {
        `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
    ...
    @Test
    fun `clearFutureReservationsAndAbsencesOutsideValidPlacements for daycare_five_year_olds placement`() {
        `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
    ...
    private fun `clearFutureReservationsAndAbsencesOutsideValidPlacements works`(
        ...
        db.transaction { tx ->
            tx.clearFutureReservationsAndAbsencesOutsideValidPlacements(child.id, today)
        }
