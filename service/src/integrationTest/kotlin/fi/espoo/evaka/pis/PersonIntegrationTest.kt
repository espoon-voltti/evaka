...
class PersonIntegrationTest : PureJdbiTest(resetDbBeforeEach = true) {
    ...
    fun `getTransferablePersonReferences returns references to person and child tables`() {
        ...
        val expected =
            listOf(
                ...
                PersonReference("child_consent", "child_id"),
                PersonReference("child_consent", "given_by_guardian"),
                PersonReference("child_daily_note", "child_id"),
                PersonReference("child_discussion", "child_id"),
                ...
                PersonReference("fee_decision_child_v2", "child_id"),
                PersonReference("fee_decision_v2", "head_of_family_id"),
                PersonReference("fee_decision_v2", "partner_id"),
    ...
    private fun personHasMessageAccount(personId: PersonId): Boolean {
        ...
        """
                .trimIndent()
        return db.read { it.createQuery(sql).bind("personId", personId).mapTo<Boolean>().first() }
    }
}
