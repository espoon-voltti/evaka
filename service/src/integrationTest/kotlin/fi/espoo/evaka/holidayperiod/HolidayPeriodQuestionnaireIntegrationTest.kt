...
class HolidayPeriodQuestionnaireIntegrationTest : PureJdbiTest() {
        ...
        val summerQuestionnaire = createFixedPeriodQuestionnaire(
            FixedPeriodQuestionnaireBody(
                ...
                conditions = QuestionnaireConditions(
                    continuousPlacement = FiniteDateRange(LocalDate.of(2020, 9, 1), summerRange.end)
                ),
    ...
    private fun createFixedPeriodQuestionnaire(body: FixedPeriodQuestionnaireBody) = db.transaction {
