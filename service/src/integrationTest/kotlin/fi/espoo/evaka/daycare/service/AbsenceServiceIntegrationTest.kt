        ...
        assertEquals(
            ...
            (missingReservationsPeriod.dates().map { date ->
                    ...
                    sequenceOf(
                        GroupMonthCalendarDay(
                            date = holidayPeriod.end.minusDays(2),
                            holiday = holidayPeriod.end.minusDays(2).isWeekend(),
                            holidayPeriod = true,
                            children =
                                listOf(
                                    emptyDayChild.copy(
                                        ...
                                        reservations =
                                            listOf(
                                                ChildReservation(
                                                    reservation = ReservationDto.NoTimes(true),
                                                    created =
                                                        HelsinkiDateTime.of(
                                                            placementStart,
                                                            LocalTime.of(8, 0)
                        ...
                        GroupMonthCalendarDay(
                            date = holidayPeriod.end.minusDays(1),
                            holiday = holidayPeriod.end.minusDays(1).isWeekend(),
                            holidayPeriod = true,
                            children =
                                listOf(
                                    emptyDayChild.copy(
                        ...
                        GroupMonthCalendarDay(
                            date = holidayPeriod.end,
                            holiday = holidayPeriod.end.isWeekend(),
                            holidayPeriod = true,
                            children =
                                listOf(
                                    emptyDayChild.copy(
