...
Lapsen tunniste: ${firstChildWithRemovedAllergy.id}, lapsen ruokavaliot: Laktoositon ruokavalio
    ...
    fun `manual order should plan weekly order if daycare times have not been locked for the order date`() {
        ...
        assertEquals(1, getNekkuWeeklyJobs().size)
        assertEquals(0, getNekkuDailyJobs().size)
    }
    ...
    fun `manual order should plan daily order if daycare times have been locked for the order date`() {
        ...
        assertEquals(0, getNekkuWeeklyJobs().size)
        assertEquals(1, getNekkuDailyJobs().size)
    }
