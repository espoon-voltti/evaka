...
class NekkuOrderIntegrationTest : FullApplicationTest(resetDbBeforeEach = true) {
    ...
    @Test
    fun `meal order jobs for daycare groups are re-planned four days before actual date also on weekend if daycare is open`() {
    ...
    fun `cleaning Nekku order report rows should work`() {
        ...
        db.transaction { tx ->
            ...
            val dates = listOf("2025-05-15", "2025-04-15", "2025-03-15", "2025-02-15", "2025-02-14", "2025-01-15")
            dates.map { date ->
            ...
            val rows = tx.getNekkuReportRows(daycare.id, listOf(group.id), LocalDate.of(2025, 1, 1), LocalDate.of(2025, 5, 31))
