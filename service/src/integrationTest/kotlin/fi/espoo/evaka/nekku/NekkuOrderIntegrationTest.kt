    ...
    fun `should deduct meals if required by a unit wide calendar event when children do not have reservations`() {
        ...
        val event =
            DevCalendarEvent(
                ...
                nekkuUnorderedMeals = listOf(NekkuFrontMealTime.LUNCH),
            )
        val attendee =
    ...
    fun `should combine meal reductions from calendar events`() {
        ...
        val event2 =
            DevCalendarEvent(
                ...
                modifiedBy = employee.evakaUserId,
                eventType = CalendarEventType.DAYCARE_EVENT,
                nekkuUnorderedMeals = listOf(NekkuFrontMealTime.SNACK),
            )
        val event3 =
            DevCalendarEvent(
                ...
                modifiedBy = employee.evakaUserId,
                eventType = CalendarEventType.DAYCARE_EVENT,
                nekkuUnorderedMeals = listOf(NekkuFrontMealTime.BREAKFAST),
            )
        val attendee1 =
            DevCalendarEventAttendee(
