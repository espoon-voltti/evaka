    ...
    fun `getTransferablePersonReferences returns references to person and child tables`() {
        ...
        val expected =
            listOf(
                ...
                PersonReference("citizen_push_subscription", "person_id"),
                ...
                PersonReference("finance_note", "person_id"),
                ...
                PersonReference("person_email_verification", "person_id"),
                PersonReference("placement", "child_id"),
                PersonReference("preschool_assistance", "child_id"),
                PersonReference("service_application", "child_id"),
                PersonReference("service_application", "person_id"),
                PersonReference("sfi_message", "guardian_id"),
