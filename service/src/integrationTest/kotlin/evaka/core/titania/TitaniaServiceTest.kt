...
import evaka.core.attendance.StaffAttendancePlan
import evaka.core.attendance.StaffAttendanceType
import evaka.core.attendance.findStaffAttendancePlansBy
import evaka.core.attendance.upsertStaffAttendance
import evaka.core.pis.createEmployee
import evaka.core.pis.getEmployeeIdsByNumbers
...
internal class TitaniaServiceTest : FullApplicationTest(resetDbBeforeEach = true) {
    ...
    @Test
    fun `getStampedWorkingTimeEvents with interrupted workday`() {
        val date = LocalDate.of(2025, 5, 19)
        val now = HelsinkiDateTime.of(date, LocalTime.of(18, 0))
        db.transaction { tx ->
            val areaId = tx.insert(DevCareArea())
            ...
            DevEmployee(firstName = "IINES", lastName = "ANKKA", employeeNumber = "177111")
                ...
                .let { employee ->
                    ...
                    tx.upsertStaffAttendance(
                        ...
                        employeeId = employee.id,
                        groupId = groupId,
                        arrivalTime = HelsinkiDateTime.of(date, LocalTime.of(6, 30)),
                        departureTime = HelsinkiDateTime.of(date, LocalTime.of(10, 26)),
                        occupancyCoefficient = BigDecimal("7.0"),
                        type = StaffAttendanceType.PRESENT,
                        modifiedAt = now,
                        modifiedBy = employee.evakaUserId,
