...
class CitizenPushNotificationsTest : FullApplicationTest(resetDbBeforeEach = true) {
    ...
    private val decision =
        CitizenPushNotification.PendingDecisions(
            listOf(PendingDecision("Test", DecisionType.DAYCARE, "Test Daycare"))
        )
        ...
        val notifications =
            listOf(
                ...
                CitizenPushNotification.Income(
                    ...
                    expirationDate = clock.today().plusDays(14),
                    deadline = null,
                ),
                CitizenPushNotification.ApplicationDecisions(
                    ...
                    decisions =
                        listOf(
                            ApplicationDecision(DecisionType.DAYCARE, "Test Daycare", clock.today())
                        ),
                    answerRequired = true,
                ),
                ...
                CitizenPushNotification.CalendarEvents(
                    listOf(
                        CalendarEventSummary(
                            title = "Retki",
                            description = "Mukaan eväät",
                            period =
                                FiniteDateRange(
                                    clock.today().plusDays(3),
                                    clock.today().plusDays(3),
                                ),
                            groupNames = listOf("Ryhmä 1"),
                        )
                    )
                ),
                ...
                CitizenPushNotification.MissingHolidayReservations(
                    holidayPeriod =
                        FiniteDateRange(clock.today().plusDays(10), clock.today().plusDays(20)),
                    deadline = clock.today().plusDays(2),
                ),
