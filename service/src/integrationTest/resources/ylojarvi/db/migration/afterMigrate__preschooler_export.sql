...
-- \copy (SELECT * FROM ylojarvi_preschooler_export(2019, current_date)) TO 'evaka_preschooler_export.csv' CSV DELIMITER ';'

DROP FUNCTION IF EXISTS ylojarvi_preschooler_export;

CREATE FUNCTION ylojarvi_preschooler_export(year_of_birth int, date date)
    RETURNS TABLE
            (
