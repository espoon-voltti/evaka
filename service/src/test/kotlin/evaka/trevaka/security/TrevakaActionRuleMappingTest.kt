...
private fun translate(action: Global) =
    action.name to
        when (action) {
            ...
            Global.MCP_PAGE -> "Tekoälytyökalut (MCP) -sivu"
            Global.MANAGE_MCP_AUTHORIZATIONS -> "Tekoälytyökalujen valtuutusten hallinta"
            Global.MANAGE_MCP_TEST_DATA -> "MCP-testidatan hallinta"
