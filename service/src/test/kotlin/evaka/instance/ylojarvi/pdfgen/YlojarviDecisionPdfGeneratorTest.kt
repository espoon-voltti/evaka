...
package evaka.instance.ylojarvi.pdfgen
...
import evaka.instance.ylojarvi.template.config.YlojarviTemplateProvider

class YlojarviDecisionPdfGeneratorTest : AbstractDecisionPdfGeneratorTest() {
    override val municipality = "ylojarvi"
