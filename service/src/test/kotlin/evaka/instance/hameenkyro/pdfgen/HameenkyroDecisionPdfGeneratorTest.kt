...
package evaka.instance.hameenkyro.pdfgen
...
import evaka.instance.hameenkyro.template.config.HameenkyroTemplateProvider

class HameenkyroDecisionPdfGeneratorTest : AbstractDecisionPdfGeneratorTest() {
