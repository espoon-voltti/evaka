...
import evaka.instance.nokia.template.config.NokiaTemplateProvider

class NokiaDecisionPdfGeneratorTest : AbstractDecisionPdfGeneratorTest() {
    override val municipality = "nokia"
    override val templateProvider: ITemplateProvider = NokiaTemplateProvider()
