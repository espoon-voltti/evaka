...
package evaka.instance.lempaala.pdfgen
...
import evaka.instance.lempaala.template.config.LempaalaTemplateProvider

class LempaalaDecisionPdfGeneratorTest : AbstractDecisionPdfGeneratorTest() {
    override val municipality = "lempaala"
    override val templateProvider: ITemplateProvider = LempaalaTemplateProvider()
