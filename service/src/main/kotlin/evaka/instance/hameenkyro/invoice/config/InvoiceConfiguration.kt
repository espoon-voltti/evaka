...
package evaka.instance.hameenkyro.invoice.config
...
import evaka.instance.hameenkyro.invoice.service.HameenkyroInvoiceIntegrationClient
import evaka.instance.hameenkyro.invoice.service.ProEInvoiceGenerator
import evaka.instance.hameenkyro.invoice.service.S3Sender
...
class InvoiceConfiguration {
    ...
    @Bean fun incomeTypesProvider(): IncomeTypesProvider = HameenkyroIncomeTypesProvider()

    @Bean
    fun incomeCoefficientMultiplierProvider(): IncomeCoefficientMultiplierProvider =
        HameenkyroIncomeCoefficientMultiplierProvider()

    @Bean fun invoiceProductProvider(): InvoiceProductProvider = HameenkyroInvoiceProductProvider()
    ...
    override fun mapToFeeAlterationProduct(
        ...
        val product =
            when (findProduct(productKey) to feeAlterationType) {
                ...
                Product.PRESCHOOL_WITH_DAYCARE to FeeAlterationType.INCREASE -> Product.CORRECTION
