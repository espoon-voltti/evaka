...
package evaka.instance.hameenkyro.message.config
...
internal const val PREFIX: String = "evaka.instance.hameenkyro.MessageProvider"
...
internal class HameenkyroMessageProvider(private val messageSource: MessageSource) :
    IMessageProvider {
