...
package evaka.instance.ylojarvi.message.config
...
internal const val PREFIX: String = "evaka.instance.ylojarvi.MessageProvider"
...
class MessageConfiguration {
    ...
    fun messageProvider(): IMessageProvider {
        val messageSource = YamlMessageSource(ClassPathResource("ylojarvi/messages.yaml"))
        return YlojarviMessageProvider(messageSource)
    }
}

internal class YlojarviMessageProvider(private val messageSource: MessageSource) :
    IMessageProvider {
