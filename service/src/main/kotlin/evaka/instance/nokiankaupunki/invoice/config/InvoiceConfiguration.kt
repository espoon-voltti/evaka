...
package evaka.instance.nokiankaupunki.invoice.config
...
import evaka.instance.nokiankaupunki.invoice.NokiaInvoiceClient
...
class InvoiceConfiguration {
    ...
    fun incomeCoefficientMultiplierProvider(): IncomeCoefficientMultiplierProvider =
        NokiaIncomeCoefficientMultiplierProvider()

    @Bean fun invoiceProductProvider(): InvoiceProductProvider = NokiaInvoiceProductProvider()
