...
package evaka.instance.lempaala.message.config
...
internal const val PREFIX: String = "evaka.instance.lempaala.MessageProvider"
...
internal class LempaalaMessageProvider(private val messageSource: MessageSource) :
    IMessageProvider {
