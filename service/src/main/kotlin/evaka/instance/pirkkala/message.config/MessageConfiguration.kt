...
package evaka.instance.pirkkala.message.config
...
internal const val PREFIX: String = "evaka.instance.pirkkala.MessageProvider"
...
internal class PirkkalaMessageProvider(private val messageSource: MessageSource) :
    IMessageProvider {
