...
package evaka.instance.kangasala.invoice.config
...
class InvoiceConfiguration {
    ...
    fun incomeCoefficientMultiplierProvider(): IncomeCoefficientMultiplierProvider =
        KangasalaIncomeCoefficientMultiplierProvider()

    @Bean fun invoiceProductProvider(): InvoiceProductProvider = KangasalaInvoiceProductProvider()
