...
package evaka.instance.kangasala.message.config
...
internal const val PREFIX: String = "evaka.instance.kangasala.MessageProvider"
...
class MessageConfiguration {
    ...
    fun messageProvider(): IMessageProvider {
        val messageSource = YamlMessageSource(ClassPathResource("kangasala/messages.yaml"))
        return KangasalaMessageProvider(messageSource)
    }
}

internal class KangasalaMessageProvider(private val messageSource: MessageSource) :
    IMessageProvider {
