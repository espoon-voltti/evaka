        ...
        dbc.read { tx ->
            ...
            setOfNotNull(
                ...
                Report.CHILD_DOCUMENTS.takeIf {
                    permittedActionsForSomeUnit.contains(Action.Unit.READ_CHILD_DOCUMENTS_REPORT)
                },
                ...
                Report.FAMILY_CONFLICT.takeIf {
                    permittedActionsForSomeUnit.contains(Action.Unit.READ_FAMILY_CONFLICT_REPORT)
                },
                ...
                Report.INCOMPLETE_INCOMES.takeIf {
                    permittedGlobalActions.contains(Action.Global.READ_INCOMPLETE_INCOMES_REPORT)
                },
                Report.INVOICE.takeIf {
                    permittedGlobalActions.contains(Action.Global.READ_INVOICE_REPORT)
                },
                Report.KOSKI_ERRORS.takeIf {
                    permittedGlobalActions.contains(Action.Global.READ_KOSKI_REPORT)
                },
                ...
                Report.PLACEMENT_SKETCHING.takeIf {
                    permittedGlobalActions.contains(Action.Global.READ_PLACEMENT_SKETCHING_REPORT)
                },
                Report.RAW.takeIf {
                ...
                Report.SERVICE_VOUCHER_VALUE.takeIf {
                    permittedActionsForSomeUnit.contains(Action.Unit.READ_SERVICE_VOUCHER_REPORT)
                },
