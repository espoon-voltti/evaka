...
import evaka.core.pis.getPartnersForPerson
...
private fun Database.Read.getPartnersFromFinanceDecisions(personId: PersonId) = createQuery {
    sql(
        """
...
private fun Database.Read.getChildrenFromFinanceDecisions(personId: PersonId) = createQuery {
    sql(
        """
        SELECT fdc.child_id 
...
private fun Database.Read.getParentsFromFinanceDecisions(personId: PersonId) = createQuery {
    sql(
        """
