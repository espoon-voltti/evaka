...
enum class Audit(
    ...
    FinanceNoteDelete,
    FinanceNoteRead,
    FosterParentCreateRelationship(securityEvent = true, securityLevel = "medium"),
    FosterParentDeleteRelationship(securityEvent = true, securityLevel = "medium"),
    FosterParentReadChildren,
    FosterParentReadParents,
    FosterParentUpdateRelationship(securityEvent = true, securityLevel = "medium"),
    FuturePreschoolers,
    ...
    McpAuthorizationCreate(securityEvent = true, securityLevel = "high"),
    McpAuthorizationRevoke(securityEvent = true, securityLevel = "medium"),
    McpClientRegister(securityEvent = true, securityLevel = "medium"),
    McpTestDataBatchDelete,
    McpTokenIssue(securityEvent = true, securityLevel = "high"),
    McpToolCall,
    McpUnauthorizedRequest(securityEvent = true, securityLevel = "low"),
    MobileDevicesList,
    MobileDevicesRead,
    MobileDevicesRename,
    ...
    TemporaryEmployeeCreate(securityEvent = true, securityLevel = "high"),
    TemporaryEmployeeRead,
    TemporaryEmployeeUpdate(securityEvent = true, securityLevel = "medium"),
    TemporaryEmployeeDeleteAcl(securityEvent = true, securityLevel = "medium"),
    TemporaryEmployeeDelete(securityEvent = true, securityLevel = "high"),
    TimelineRead,
    TitaniaReportDelete,
    TitaniaReportRead,
    ...
    IncomeCoefficientMultipliersRead,
    ...
    UnitAclActivateScheduled(securityEvent = true, securityLevel = "medium"),
    UnitAclCreate(securityEvent = true, securityLevel = "medium"),
    UnitAclDelete(securityEvent = true, securityLevel = "medium"),
    UnitAclDeleteExpired(securityEvent = true, securityLevel = "medium"),
    UnitAclDeleteScheduled(securityEvent = true, securityLevel = "medium"),
    UnitAclRead,
    UnitAclUpdate(securityEvent = true, securityLevel = "medium"),
