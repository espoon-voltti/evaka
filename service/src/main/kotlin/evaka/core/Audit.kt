...
enum class Audit(
    ...
    CitizenPasskeyLogin(securityEvent = true, securityLevel = "high"),
    CitizenPasskeyLoginAttempt(securityEvent = true, securityLevel = "high"),
    CitizenPasskeyRegister(securityEvent = true, securityLevel = "high"),
    CitizenPasskeyRegisterAttempt(securityEvent = true, securityLevel = "high"),
    CitizenPasskeysRead,
