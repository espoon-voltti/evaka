...
import evaka.core.application.PlacementToolData
...
import evaka.core.koski.KoskiStudyRightKey
...
sealed interface AsyncJob : AsyncJobPayload {
    ...
    data class SendNewBrowserLoginEmail(val personId: PersonId) : AsyncJob {
        override val user: AuthenticatedUser? = null
    }
    ...
    data class SendPasskeyAddedEmail(val personId: PersonId) : AsyncJob {
        override val user: AuthenticatedUser? = null
    }

    data class SendPasskeyRemovedEmail(val personId: PersonId) : AsyncJob {
        override val user: AuthenticatedUser? = null
    }
