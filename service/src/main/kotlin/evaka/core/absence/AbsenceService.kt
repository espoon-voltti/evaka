...
import evaka.core.absence.AbsenceType.OTHER_ABSENCE
import evaka.core.absence.AbsenceType.PLANNED_ABSENCE
import evaka.core.absence.AbsenceType.SICKLEAVE
import evaka.core.attendance.childrenHaveAttendanceInRange
import evaka.core.dailyservicetimes.DailyServiceTimesValue
import evaka.core.dailyservicetimes.ServiceTimesPresenceStatus
import evaka.core.dailyservicetimes.getChildDailyServiceTimes
...
import evaka.core.holidayperiod.getHolidayPeriodsInRange
import evaka.core.holidayperiod.getHolidayQuestionnaires
...
import evaka.core.reservations.computeUsedService
...
import evaka.core.serviceneed.getActualServiceNeedInfosByRangeAndGroup
...
import evaka.core.shared.data.DateTimeSet
...
class AbsenceService(
    ...
    fun createAbsences(
        ...
        audit.add(deletedAbsences).add(insertedAbsences)
        deletedReservations?.let { audit.add(it) }
    }
}
...
data class ChildServiceNeedInfo(
    ...
    val optionNameFi: String,
    val optionNameSv: String,
