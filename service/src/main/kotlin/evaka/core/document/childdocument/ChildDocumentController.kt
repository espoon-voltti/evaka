                    ...
                    documents
                        ...
                        .onEach {
                            audit
                                .add(it.data.id)
                                .observeDate(
                                    (it.data.publishedAt ?: it.data.modifiedAt).toLocalDate()
                                )
                        }
                }
            }
        ...
        return db.connect { dbc ->
                dbc.read { tx ->
                    ...
                    audit
                        ...
                        .observeDate((document.publishedAt ?: document.modifiedAt).toLocalDate())
    ...
    fun getAcceptedChildDocumentDecisions(
        ...
        return db.connect { dbc ->
                dbc.read { tx ->
                    ...
                    tx.getAcceptedChildDocumentDecisions(documentId).onEach {
                        audit.add(it.id).observeDate(it.validity.start)
                    }
                }
            }
