...
fun Database.Read.fetchApplicationSummaries(
    ...
    val params = listOf(
        ...
        Binding.of("units", units.toTypedArray()),
        Binding.of("authorizedUnitsForApplicationsWithoutAssistanceNeed", authorizedUnitsForApplicationsWithoutAssistanceNeed.ids?.toTypedArray()),
        Binding.of("authorizedUnitsForApplicationsWithAssistanceNeed", authorizedUnitsForApplicationsWithAssistanceNeed.ids?.toTypedArray()),
        Binding.of("documentType", type.toApplicationType()),
        Binding.of("preschoolType", preschoolType.toTypedArray()),
        Binding.of("status", statuses.map { it.toStatus() }.toTypedArray()),
        Binding.of("distinctions", distinctions.map { it.toString() }.toTypedArray()),
        Binding.of("dateType", dateType.map { it.toString() }.toTypedArray()),
