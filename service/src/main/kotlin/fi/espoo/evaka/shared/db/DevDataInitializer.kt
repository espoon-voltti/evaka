...
class DevDataInitializer(jdbi: Jdbi, tracer: Tracer, personService: PersonService) {
    init {
        ...
        (personService.personDetailsService as MockPersonDetailsService).add(legacyMockVtjDataset())
    }
}
