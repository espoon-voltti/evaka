...
sealed interface Action {
    ...
    * */
    enum class Global(private val roles: EnumSet<UserRole>) : Action {
        ...
        READ_USER_MESSAGE_ACCOUNTS(DIRECTOR, REPORT_VIEWER, FINANCE_ADMIN, SERVICE_WORKER, UNIT_SUPERVISOR, STAFF, SPECIAL_EDUCATION_TEACHER, MOBILE),

        READ_APPLCIATIONS_REPORT(SERVICE_WORKER, DIRECTOR, REPORT_VIEWER),
        ...
        READ_ENDED_PLACEMENTS_REPORT(FINANCE_ADMIN),
        ...
        READ_OCCUPANCY_REPORT(SERVICE_WORKER, DIRECTOR, REPORT_VIEWER),
