...
class FamilyDaycareMealReport(private val accessControl: AccessControl) {
    ...
    fun getFamilyDaycareMealReport(
        ...
        val defaultMealTimes =
            MealReportConfig(
                breakfastTime = TimeRange.of(LocalTime.of(8, 0, 0, 0), LocalTime.of(8, 45, 0, 0)),
                lunchTime = TimeRange.of(LocalTime.of(10, 30, 0, 0), LocalTime.of(12, 30, 0, 0)),
                snackTime = TimeRange.of(LocalTime.of(13, 45, 0, 0), LocalTime.of(15, 0, 0, 0))
            )
