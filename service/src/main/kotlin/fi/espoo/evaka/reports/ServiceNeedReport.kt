...
@RestController
class ServiceNeedReport(private val jdbc: NamedParameterJdbcTemplate) {
    ...
    fun getChildAgeLanguageReport(
        ...
        return getServiceNeedRows(jdbc, date).let(::ok)
    }
}

fun getServiceNeedRows(jdbc: NamedParameterJdbcTemplate, date: LocalDate): List<ServiceNeedReportRow> {
    // language=sql
    val sql =
        """
