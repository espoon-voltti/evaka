...
SELECT
    ...
    coalesce(sn.shift_care, false) AS shift_care,
...
LEFT JOIN absences_in_range(ARRAY[p.id], daterange(t::date, t::date, '[]')) ab1 on ab1.category = 'BILLABLE'
LEFT JOIN absences_in_range(ARRAY[p.id], daterange(t::date, t::date, '[]')) ab2 on ab2.category = 'NONBILLABLE'
