...
class EspooIncomeTypesProvider : IncomeTypesProvider {
    override fun get(): Map<String, IncomeType> {
        return linkedMapOf(
            ...
            "UNEMPLOYMENT_BENEFITS" to IncomeType("Työttömyyskorvaus/työmarkkinatuki", 1, false, false),
            ...
            "HOME_CARE_ALLOWANCE" to IncomeType("Kotihoidontuki, joustava/osittainen hoitoraha", 1, false, false),
            ...
            "ALL_EXPENSES" to IncomeType("Menot (esim. maksetut elatusmaksut tai syytinki)", -1, false, false)
        )
    }
}
