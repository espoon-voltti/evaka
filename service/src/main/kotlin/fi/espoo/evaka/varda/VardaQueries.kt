...
SELECT
    ...
    sn.start_date,
    sn.end_date,
    LEAST(COALESCE(application_match.sentdate, application_match.created_at::date), sn.start_date - interval '15 days') AS application_date,
...
JOIN daycare d ON p.unit_id = d.id
LEFT JOIN LATERAL (
    SELECT a.id, a.sentdate, a.created_at, a.document
    FROM application a
