...
data class OpiskeluoikeudenTyyppi(
    override val koodiarvo: OpiskeluoikeudenTyyppiKoodi
...
data class SuorituksenTyyppi(
    override val koodiarvo: SuorituksenTyyppiKoodi
...
data class KoulutusmoduulinTunniste(
    override val koodiarvo: KoulutusmoduulinTunnisteKoodi
...
data class OpiskeluoikeusjaksonTila(
    override val koodiarvo: OpiskeluoikeusjaksonTilaKoodi
...
data class Järjestämismuoto(
    override val koodiarvo: JärjestämismuotoKoodi
...
abstract class Koodistokoodiviite<T>(
