    ...
    companion object {
        fun fromEnvironment(env: Environment) =
            JwtEnv(
                publicKeysUrl =
                    env.lookup(
                        "evaka.jwt.public_keys_url",
                        "fi.espoo.voltti.auth.jwks.default.url"
                    ),
            )
    }
}
            ...
            DatabaseEnv(
                ...
                leakDetectionThreshold =
                    env.lookup(
                        ...
                        ?: 0,
                defaultStatementTimeout = env.lookup("evaka.database.default_statement_timeout")
    ...
    companion object {
        fun fromEnvironment(env: Environment) =
            KoskiEnv(
                ...
                municipalityCallerId = env.lookup("evaka.integration.koski.municipality_caller_id")
                        ?: "espooevaka"
            )
    }
}
