...
class AssistanceNeedPreschoolDecisionService(
    ...
    fun runCreateAssistanceNeedPreschoolDecisionPdf(
        ...
        db.transaction { tx ->
            ...
            tx.getCaseProcessByAssistanceNeedPreschoolDecisionId(msg.decisionId)?.also {
        ...
        db.transaction { tx ->
            ...
            tx.getChildGuardiansAndFosterParents(decision.child.id, clock.today())
                ...
                .forEach { guardian ->
                    ...
                    logger.warn {
                        "AssistanceNeedPreschoolDecisionService sent an SFI message with id: $sfiMessageId"
                    }
