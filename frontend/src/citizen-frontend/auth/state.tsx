      ...
      user: authStatus.map((a) =>
        a.loggedIn
          ? {
              ...
              accessibleFeatures:
                // TODO: remove this extra backwards compatibility code and fetch from one property only
                ((a.user.details as any) // oxlint-disable-line @typescript-eslint/no-explicit-any
                  .accessibleFeatures as CitizenFeatures) ?? // oxlint-disable-line @typescript-eslint/no-unsafe-member-access
