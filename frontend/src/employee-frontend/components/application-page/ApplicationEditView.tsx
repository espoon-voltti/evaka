...
export default React.memo(function ApplicationEditView({
  ...
  const minDate = LocalDate.todayInSystemTz().subYears(10)
  const maxDate = LocalDate.todayInSystemTz().addYears(10)
          ...
          >
            <FileUpload
              ...
              onUploaded={(attachment) =>
                setServiceWorkerAttachments((prev) => [
                  ...prev,
                  {
                    ...attachment,
                    type: 'SERVICE_WORKER_ATTACHMENT',
              ...
              files={serviceWorkerAttachments}
