            ...
            <FixedSpaceColumn spacing="L">
              ...
              <FixedSpaceRow spacing="L">
                ...
                <ReportDownload
                  ...
                  headers={[
                    { label: t.columns.month, key: 'month' },
                    {
                      label: t.columns.municipalOver3FullTimeCount,
                      key: 'municipalOver3FullTimeCount'
                    },
                    {
                      label: t.columns.municipalOver3PartTimeCount,
                      key: 'municipalOver3PartTimeCount'
                    },
                    {
                      label: t.columns.municipalUnder3FullTimeCount,
                      key: 'municipalUnder3FullTimeCount'
                    },
                    {
                      label: t.columns.municipalUnder3PartTimeCount,
                      key: 'municipalUnder3PartTimeCount'
                    },
                    {
                      label: t.columns.familyOver3Count,
                      key: 'familyOver3Count'
                    },
                    {
                      label: t.columns.familyUnder3Count,
                      key: 'familyUnder3Count'
                    },
                    {
                      label: t.columns.municipalShiftCareCount,
                      key: 'municipalShiftCareCount'
                    },
                    {
                      label: t.columns.municipalAssistanceCount,
                      key: 'assistanceCount'
                    }
                  ]}
