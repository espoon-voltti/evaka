...
export namespace Action {
  ...
  export type AssistanceAction = 'DELETE' | 'UPDATE'

  export type AssistanceNeed = 'DELETE' | 'UPDATE'

  export type BackupCare = 'DELETE' | 'UPDATE'

  export type BackupPickup = 'DELETE' | 'UPDATE'
  ...
  export type ChildDailyNote = 'DELETE' | 'UPDATE'
  ...
  export type GroupPlacement = 'DELETE' | 'UPDATE'
  ...
  export type ServiceNeed = 'DELETE' | 'UPDATE'
  ...
  export type VasuTemplate = 'COPY' | 'DELETE' | 'READ' | 'UPDATE'
}
