...
const en: DeepPartial<Translations> = {
  ...
  loginPage: {
    helpUrl:
      'https://hameenkyro.fi/palvelut/kasvatus-ja-opetus/varhaiskasvatus/varhaiskasvatuksen-jarjestaminen/',
    login: {
      infoBoxText: (
        <>
          <P>
  ...
  accessibilityStatement: (
    <>
      ...
      <P>
        ...
        Municipality of Hämeenkyrö strives to guarantee the accessibility of the
