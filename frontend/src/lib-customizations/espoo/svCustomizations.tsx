...
export default {
  applicationsList: {
    ...
    summary: `Barnets vårdnadshavare kan anmäla barnet till förskolan eller ansöka om plats i småbarnspedagogisk verksamhet. Uppgifter om vårdnadshavarens barn kommer automatiskt från befolkningsdatabasen till denna sida.`
  },
  footer: {
    cityLabel: '© Esbo stad',
    privacyPolicyLink:
