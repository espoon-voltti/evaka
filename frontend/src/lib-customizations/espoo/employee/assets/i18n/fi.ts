  ...
  reports: {
    ...
    duplicatePeople: {
      ...
      columns: {
        ...
        'fee_decision.head_of_family': 'Maksu- päätöksiä (päämies)',
        'fee_decision.partner': 'Maksu- päätöksiä (puoliso)',
        'fee_decision_part.child': 'Maksu- päätös- rivejä',
        ...
        'new_fee_decision.head_of_family_id': 'Maksu- päätöksiä (päämies) v2',
        'new_fee_decision.partner_id': 'Maksu- päätöksiä (puoliso) v2',
        'new_fee_decision_child.child_id': 'Maksu- päätös- rivejä v2',
        'placement.child_id': 'Sijoituksia',
        'service_need.child_id': 'Palvelun tarpeita',
