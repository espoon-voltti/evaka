...
const customerContactText = function () {
  return (
    <>
      <a href="mailto:varhaiskasvatus@orivesi.fi">varhaiskasvatus@orivesi.fi</a>
    </>
  )
}
  ...
  accessibilityStatement: (
    <>
      ...
      <P>
        ...
        Orivesi strives to guarantee the accessibility of the online service,
      ...
      <P>
        ...
        <br />
        Email:{' '}
        <a href="mailto:varhaiskasvatus@orivesi.fi">
          varhaiskasvatus@orivesi.fi
        </a>
      </P>
      ...
      <P>
        ...
        let us, the administrators, know. You can report accessibility issues or
        provide feedback via email at{' '}
        <a href="mailto:varhaiskasvatus@orivesi.fi">
          varhaiskasvatus@orivesi.fi
        </a>
