...
const en: DeepPartial<Translations> = {
  ...
  loginPage: {
    helpUrl:
      'https://pirkkala.fi/palvelut/kasvatus-ja-opetus/varhaiskasvatus/varhaiskasvatuksen-jarjestaminen/',
    login: {
      infoBoxText: (
        <>
          <P>
  ...
  accessibilityStatement: (
    <>
      ...
      <P>
        ...
        early childhood education eVaka online service at{' '}
        <a href="https://evaka.pirkkala.fi">evaka.pirkkala.fi</a>. The
        Municipality of Pirkkala strives to guarantee the accessibility of the
      ...
      <P>
        <strong>Early childhood education service guidance</strong>
        <br />
        Email:{' '}
        <a href="mailto:varhaiskasvatus@pirkkala.fi">
          varhaiskasvatus@pirkkala.fi
        ...
        <br />
        Telephone: <a href="tel:0505972469">050 597 2469</a>
      </P>
